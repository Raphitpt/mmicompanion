  ...
  function buildButtonDef(trumbowyg) {
    return {
      fn: function () {
        ...
        var modalContent =
          '<label>Question : <input id="pollQuestion" type="text"></label>';
        ...
        trumbowyg.openModal(
          "Saisir les détails du StrawPoll",
          modalContent,
          function () {
            ...
            xhr.setRequestHeader(
              "X-API-Key",
              "e2357040-71cb-11ee-ba08-a87f99aa68de"
            ...
            xhr.onload = function () {
              if (xhr.status === 200) {
                ...
                console.error(
                  "Erreur lors de la création du StrawPoll : " + xhr.status
                );
              }
        ...
        $("#customConfirm").on("click", function () {
          ...
          xhr.open("POST", "https://api.strawpoll.com/v3/polls");
          xhr.setRequestHeader("Content-Type", "application/json");
          xhr.setRequestHeader(
            "X-API-Key",
            "e2357040-71cb-11ee-ba08-a87f99aa68de"
    ...
    plugins: {
      myplugin: {
        ...
        init: function (trumbowyg) {
          ...
          trumbowyg.o.plugins.myplugin = $.extend(
            true,
            {},
            defaultOptions,
